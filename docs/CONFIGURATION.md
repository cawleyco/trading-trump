...
| `CONGRESS_GOV_API_KEY` | No | Congress.gov bill/activity refresh for the political knowledge graph and committee-hearing collection for the calendar. If empty, bill and hearing refreshes are skipped while committees, lobbying, contracts, static calendar events, and scoring still degrade gracefully. |
